...
public struct KeyTableSet: Codable, Sendable, Equatable {
    ...
    public static var defaults: KeyTableSet {
        let prefix = KeyTable(id: .prefix, bindings: [
            ...
            Binding(spec: KeySpec(key: "n"), command: .nextSession, note: "Next session"),
            Binding(spec: KeySpec(key: "p"), command: .previousSession, note: "Previous session"),
            Binding(spec: KeySpec(key: ","), command: .renameWindow(newName: nil), note: "Rename tab"),
            Binding(spec: KeySpec(key: "0"), command: .selectSession(index: 0), note: "Session 0"),
            Binding(spec: KeySpec(key: "1"), command: .selectSession(index: 1), note: "Session 1"),
            Binding(spec: KeySpec(key: "2"), command: .selectSession(index: 2), note: "Session 2"),
            Binding(spec: KeySpec(key: "3"), command: .selectSession(index: 3), note: "Session 3"),
            Binding(spec: KeySpec(key: "4"), command: .selectSession(index: 4), note: "Session 4"),
            Binding(spec: KeySpec(key: "5"), command: .selectSession(index: 5), note: "Session 5"),
            Binding(spec: KeySpec(key: "6"), command: .selectSession(index: 6), note: "Session 6"),
            Binding(spec: KeySpec(key: "7"), command: .selectSession(index: 7), note: "Session 7"),
            Binding(spec: KeySpec(key: "8"), command: .selectSession(index: 8), note: "Session 8"),
            Binding(spec: KeySpec(key: "9"), command: .selectSession(index: 9), note: "Session 9"),
            // Modes
